...
public class VectorLine {
	...
	public Material material {
		...
		set {
			m_material = value;
			vectorObject.GetComponent<Renderer>().material = m_material;
		}
	}
	bool m_active = true;
	public bool active {
	...
	void AddEndCap () {
		...
		vectorObject.GetComponent<Renderer>().sharedMaterials = materials;
	}
	...
	void RemoveEndCap () {
		...
		materials[0] = vectorObject.GetComponent<Renderer>().materials[0];
		vectorObject.GetComponent<Renderer>().materials = materials;
	}
